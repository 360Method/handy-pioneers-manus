...
/**
 * These case studies still need their job photos.
 *
 * Every one of them used to load from Manus's CloudFront bucket. On 2026-08-26
 * that bucket began answering 403 AccessDenied to every request and the photos
 * are not recoverable from it. They are documentary evidence of specific jobs,
 * so they were deliberately NOT replaced with stock or generated imagery: a
 * case study that shows a picture of someone else's work is worse than one that
 * shows no picture. The pages stay live and indexed, and render text-only until
 * the real photos are dropped into client/public/images/ and wired up here.
 *
 * The originals were: porch-step-before-after, gutter-cleaning-before-after,
 * graffiti-removal, porch-screen-before-after, kitchen-cabinet,
 * shower-recaulking, porch-steps-replacement, kitchen-cooktop, driveway-pw-1..3,
 * deck-washing, house-washing, window-cleaning.
 */
const PHOTO_NEEDED = "";
...
export const projects: Project[] = [
  {
    ...
    extraImages: [
      "/images/porch-post-before-after-camas-2026-08.webp",
  ...
  },
  {
    ...
    image: PHOTO_NEEDED, // was `${CDN}/porch-step-before-after_e99469e2.png`,
  ...
  },
  {
    ...
    image: PHOTO_NEEDED, // was `${CDN}/gutter-cleaning-before-after_59d3998e.png`,
  ...
  },
  {
    ...
    image: PHOTO_NEEDED, // was `${CDN}/graffiti-removal_9fbe4828.png`,
  ...
  },
  {
    ...
    image: PHOTO_NEEDED, // was `${CDN}/porch-screen-before-after_71f6836e.png`,
  ...
  },
  {
    ...
    image: PHOTO_NEEDED, // was `${CDN}/kitchen-cabinet_642933c3.png`,
  ...
  },
  {
    ...
    image: PHOTO_NEEDED, // was `${CDN}/shower-recaulking_4ec1b209.webp`,
  ...
  },
  {
    ...
    image: PHOTO_NEEDED, // was `${CDN}/porch-steps-replacement_4121aa4e.png`,
  ...
  },
  {
    ...
    image: PHOTO_NEEDED, // was `${CDN}/kitchen-cooktop_e7072d75.png`,
  ...
  },
  {
    ...
    image: PHOTO_NEEDED, // was `${CDN}/driveway-pw-1_64f291b3.png`,
    extraImages: [
      // PHOTO NEEDED: driveway-pw-2_14482dc2.png
      // PHOTO NEEDED: driveway-pw-3_973ec259.png
    ],
  ...
  },
  {
    ...
    image: PHOTO_NEEDED, // was `${CDN}/deck-washing_39b2272a.png`,
  ...
  },
  {
    ...
    image: PHOTO_NEEDED, // was `${CDN}/house-washing_aa00df1e.webp`,
  ...
  },
  {
    ...
    image: PHOTO_NEEDED, // was `${CDN}/window-cleaning_2282ea39.png`,
