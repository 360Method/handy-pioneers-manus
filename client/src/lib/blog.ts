...
export const blogPosts: BlogPost[] = [
  ...
  {
    slug: "updating-trim-older-home-clark-county",
    title: "Updating Trim in an Older Clark County Home: What to Know First",
    excerpt: "New trim can transform an older home, but pre-1978 paint and original millwork change how the job should be done. Here is what to check before anything comes off the wall.",
    ...
    category: "Interior Carpentry",
    audience: ["Homeowners"],
    tags: ["older home trim", "lead paint RRP", "original millwork", "trim replacement Vancouver WA", "historic homes"],
    image: "https://handypioneers.com/images/blog/updating-trim-older-home-clark-county.webp",
    imageAlt: "Original painted wood door casing and baseboard in an older home, with layers of paint visible at a chipped corner",
    readTime: 5,
    seoTitle: "Updating Trim in an Older Home in Clark County, WA: Lead Paint and Original Millwork | Handy Pioneers",
    seoDesc: "Before replacing trim in a pre-1978 Clark County home: the EPA lead paint rule, when to keep original millwork, and how to match old profiles.",
    body: [
      { type: "p", text: "If your home was built before 1978, the painted trim may contain lead paint, and that changes how it should be removed. Under the EPA's Renovation, Repair and Painting rule, anyone paid to disturb painted surfaces in a pre-1978 home must be an EPA-certified firm using lead-safe work practices, unless the work disturbs six square feet or less of paint per room inside [1]. Pulling baseboard and casing throughout a room usually exceeds that. So before any trim comes off an older home, the first question is when the house was built, and the second is whether the original millwork is worth keeping." },
      { type: "h2", text: "Check the paint first" },
      { type: "p", text: "Prying off trim, sanding, and cutting painted wood all create dust. In a pre-1978 home, that dust can contain lead. The RRP rule exists because that dust is a real hazard, especially for young children and pregnant women [1]. Ask any contractor you hire whether they are an EPA-certified firm, and what their containment and cleanup look like. If they do not have a clear answer, keep looking." },
      { type: "h2", text: "Decide what to keep" },
      { type: "p", text: "Many older homes in Vancouver's established neighborhoods and around downtown Camas have original fir trim with wide casings and profiles you cannot buy off the shelf anymore. Before replacing it:" },
      { type: "ul", items: [
        "Look at condition. Dents, gaps, and paint buildup can often be repaired, and repair usually costs less than replacement.",
        "Look at what is missing. A home that lost its original casings in one room can often be matched from the rooms that still have them.",
        "Consider the whole house. Replacing trim in one room with a modern profile can make it look out of place next to the others.",
      ] },
      { type: "h2", text: "Matching old profiles" },
      { type: "p", text: "Common profiles are still stocked. Older or unusual ones may need to be built up from several stock pieces, or milled to match. We tell you up front where a match will be exact, close, or not possible, so you can decide room by room." },
      { type: "h2", text: "When new trim makes sense" },
      { type: "ul", items: [
        "The original trim was already replaced with thin, builder-grade profiles",
        "Water damage or rot has reached the wood",
        "You are remodeling and the room's style is changing",
        "The trim is so layered with paint that the profile is gone",
      ] },
      { type: "p", text: "Whatever the choice, older homes also tend to have walls that are not flat and floors that are not level, so new trim takes more scribing and fitting than it would in a newer house. That is normal, and it is what separates trim that looks original from trim that looks added." },
      { type: "cta", text: "Updating trim in an older home? We will walk it, tell you what is worth keeping, and plan the work around the house's age.", ctaLabel: "See Finish Carpentry", ctaAction: "link", ctaHref: "/services/carpentry-trim" },
    ],
    references: [
      { label: "U.S. EPA, Renovation, Repair and Painting Program: Contractors", url: "https://www.epa.gov/lead/renovation-repair-and-painting-program-contractors" },
    ],
  },
