...
export const blogPosts: BlogPost[] = [
  ...
  {
    slug: "how-building-an-adu-works-clark-county",
    title: "How Building an ADU Works in Clark County, WA: Every Step From Idea to Move-In",
    excerpt: "Six phases, in order: feasibility, design, permits, a fixed contract, construction with inspections, and final sign-off. What happens in each, what you decide, and how long to plan for.",
    ...
    audience: ["Homeowners"],
    tags: ["ADU Clark County", "ADU permit Vancouver WA", "how to build an ADU", "garage conversion ADU", "detached ADU", "ADU timeline"],
    image: "https://handypioneers.com/images/blog/how-building-an-adu-works-clark-county.webp",
    imageAlt: "ADU floor plans, a site plan, and a tape measure on a table with a backyard visible through the window",
    readTime: 9,
    seoTitle: "How to Build an ADU in Clark County, WA: Steps, Permits & Timeline (2026) | Handy Pioneers",
    seoDesc: "The ADU process in Clark County and Vancouver, WA, step by step: feasibility, design, permit review, construction inspections, and move-in, with realistic timeframes and official sources.",
    body: [
      { type: "p", text: "Building an ADU in Clark County moves through six phases: a feasibility check on your lot, design and a permit-ready plan set, permit review by the city or county, a fixed scope and contract, construction with inspections at each stage, and a final inspection before anyone moves in. For planning, most homeowners should expect roughly 6 to 12 months from first walkthrough to move-in for a conversion or attached suite, and longer for a detached unit, because construction alone can run anywhere from 3 to 12 months depending on the project [1]. The phases are the same whether you convert a garage, attach a suite, or build a backyard cottage. What changes is how much gets built." },
      { type: "h2", text: "First, what the rules now allow" },
      { type: "p", text: "Washington's ADU law requires cities and counties in urban growth areas to allow at least two ADUs on a lot, bars them from requiring the owner to live on site, and bars size caps below 1,000 square feet [2]. Vancouver allows up to two ADUs per lot at 1,000 square feet or less [3]. Unincorporated Clark County caps an ADU at 1,000 square feet, or 1,500 on lots of 20,000 square feet or more [4]. Local details still vary by address, which is why every project starts with phase one." },
      { type: "h2", text: "Phase 1: Walkthrough and feasibility (1 to 3 weeks)" },
      { type: "p", text: "Before anyone draws a line, confirm what your specific lot allows and what it will take to serve a second home. This is where the expensive surprises get caught early." },
      { type: "ul", items: [
        "Zoning, size limits, and setbacks for your parcel",
        "Separation from the house: in Vancouver a detached ADU must sit at least 10 feet from other structures, or add sprinklers or fire-rated construction [3]",
        "Utilities: where water, sewer, and power come from. Vancouver asks for a Request for Utility Services, and its results, before you apply for the permit [3]",
        "Which ADU type fits your goal and budget: conversion, attached, or detached",
      ] },
      { type: "h2", text: "Phase 2: Plans and engineering (4 to 10 weeks)" },
      { type: "p", text: "An architect or residential designer turns the idea into a permit-ready plan set, with structural engineering where the project needs it. We do not draw plans or do engineering in-house, and we recommend having them done before you price construction, so the number is built on real drawings. Clark County's residential checklist calls for a foundation plan, floor plans, cross sections, exterior elevations, framing and bracing details, engineering where needed, and Washington energy code forms including a window schedule and heating sizing [5]. This is also where most of your material decisions happen, because they are drawn into the plans: windows, exterior siding and roofing, heating type, and the finish level that sets the budget." },
      { type: "h2", text: "Phase 3: Permit application and plan review (1 to 3 months)" },
      { type: "p", text: "The plan set goes to the City of Vancouver, Clark County, or your city. Vancouver's residential process runs in five steps: application submittal, prescreen review, technical plan review, plan approval with final fees, and permit issuance, after which construction can begin [6]. State law gives local governments 65 days to issue a final decision on a complete application that needs no public notice [7]. The word that matters is complete. A thorough, well-drawn application is the single biggest thing that keeps this phase short." },
      { type: "p", text: "Fees are part of this phase. By state law, impact fees on an ADU can be no more than half of what a new house would pay [2]. Vancouver charges ADUs 50 percent of the principal home's impact fees [3], and unincorporated Clark County waives 75 percent of its transportation, school, and park impact fees for ADUs [4]." },
      { type: "h2", text: "Phase 4: Fixed scope and contract (1 to 2 weeks)" },
      { type: "p", text: "With approved plans, the price can be built from the actual drawings instead of a guess. A good contract here has a written scope, a payment schedule tied to construction milestones rather than dates, and a start date. Order long-lead items now: windows, cabinets, and anything special-order." },
      { type: "h2", text: "Phase 5: Construction and inspections (2 to 8 months, by type)" },
      { type: "p", text: "Construction follows the inspection sequence, because each stage has to pass before it gets covered up. Clark County's typical sequence runs: erosion control, setbacks and footing steel, footing drains before backfill, floor framing, shear walls, rough plumbing and mechanical, framing (with rough electrical complete), insulation, drywall nailing, and final [8]. In Vancouver, city building and electrical inspectors do the inspections [9]; outside cities that run their own electrical program, electrical permits come from Washington's Department of Labor and Industries [10]." },
      { type: "ul", items: [
        "Garage or basement conversion: roughly 2 to 4 months. The shell exists, so the work is interior: egress, insulation, systems, kitchen, and bath.",
        "Attached suite: roughly 4 to 6 months. Foundation, framing, and a roof tie-in to the house come first.",
        "Detached unit: roughly 4 to 8 months. A complete small house from bare ground, including utility trenching.",
      ] },
      { type: "h2", text: "Phase 6: Final inspection and move-in (1 to 2 weeks)" },
      { type: "p", text: "The final inspection closes the permit. In unincorporated Clark County, an ADU needs a Certificate of Occupancy before anyone moves in [4]. Keep every document: the permit record, warranties, and a record of what was built and where. It matters for rental, insurance, and resale." },
      { type: "h2", text: "The code details that decide conversions and attached units" },
      { type: "ul", items: [
        "Converted living space in Vancouver needs a finished ceiling of at least 6 feet 8 inches and legal egress windows [3]",
        "A garage or other unheated space that becomes living space must be brought fully up to the Washington State Energy Code [11]",
        "Attached ADUs in Vancouver need 1-hour fire-rated construction and a sound rating of STC/IIC 45 between units [3]",
        "Each unit needs its own lockable door, and shared utilities need separate shutoffs and independent temperature control [3]",
      ] },
      { type: "h2", text: "How we run it" },
      { type: "p", text: "We start with the feasibility walkthrough, so you hire a designer knowing what your lot allows. Then we review the drawings for buildability and cost as they come together, price the build from the approved plans, and build it as one accountable engagement with one point of contact and a written schedule. We would rather spend an extra week in feasibility than have you find out in plan review that the lot will not take the unit you designed. And once it is built, the unit joins the rest of your home in our proactive care, because an ADU that earns rent for years is an asset worth protecting." },
      { type: "cta", text: "Thinking about an ADU? Start with phase one: we will walk your lot and tell you what fits, what it takes, and what to budget.", ctaLabel: "See ADU Services", ctaAction: "link", ctaHref: "/services/accessory-dwelling-units" },
    ],
    references: [
      { label: "City of Bellingham, ADU Homeowner Handbook (construction typically 3 to 12 months)", url: "https://cob.org/wp-content/uploads/adu-homeowner-handbook.pdf" },
      { label: "Washington State Legislature, RCW 36.70A.681 (accessory dwelling units)", url: "https://app.leg.wa.gov/RCW/default.aspx?cite=36.70A.681" },
      ...
      { label: "Clark County, Accessory Dwelling Unit (urban)", url: "https://clark.wa.gov/community-development/accessory-dwelling-unit-urban" },
      { label: "Clark County, Residential Building Permit Application Packet and Checklists", url: "https://clark.wa.gov/sites/default/files/media/document/2022-09/res-app-and-checklists.pdf" },
      { label: "City of Vancouver, Residential Building Permits", url: "https://www.cityofvancouver.us/business/building-construction/residential-building-permits/" },
      { label: "Washington State Legislature, RCW 36.70B.080 (permit review time limits)", url: "https://app.leg.wa.gov/rcw/default.aspx?cite=36.70b.080" },
      ...
      { label: "City of Vancouver, Schedule a Building Inspection", url: "https://www.cityofvancouver.us/government/community-development/schedule-a-building-inspection/" },
      { label: "Washington L&I, City Electrical Permits and Inspections", url: "https://lni.wa.gov/licensing-permits/electrical/electrical-permits-fees-and-inspections/city-electrical-permits-inspections" },
      { label: "Washington State Building Code Council, 2021 Washington State Energy Code, Residential (R502.2)", url: "https://sbcc.wa.gov/sites/default/files/2024-10/2021%20WSEC_R%20_Sept2024.pdf" },
    ],
  },

  {
    slug: "detached-adu-construction-sequence-clark-county",
    title: "Building a Detached ADU: The Construction Sequence, Inspections, and Materials",
    excerpt: "A detached ADU is a small house built from bare ground. Here is the build in order, every inspection that sets the pace, and the material choices that matter most in our climate.",
    date: "September 24, 2026",
    isoDate: "2026-09-24",
    publishDate: "2026-09-24",
    author: "Marcin Micek | Handy Pioneers",
    category: "ADUs & Additions",
    audience: ["Homeowners"],
    tags: ["detached ADU", "backyard cottage", "ADU construction", "ADU builder Vancouver WA", "ADU materials"],
    image: "https://handypioneers.com/images/blog/detached-adu-construction-sequence-clark-county.webp",
    imageAlt: "A small detached backyard ADU framed and sheathed, with the roof on, in a Pacific Northwest yard",
    readTime: 8,
    seoTitle: "Detached ADU Construction: Step-by-Step Sequence, Inspections & Materials | Handy Pioneers, Clark County WA",
    seoDesc: "How a detached ADU gets built in Clark County, WA: site work, foundation, framing, dry-in, rough-ins, insulation, drywall, finishes, and the inspection at each step, plus the materials worth choosing carefully.",
    body: [
      { type: "p", text: "A detached ADU is built in the same order as any new house: site work and utilities, foundation, framing and roof, rough plumbing, mechanical, and electrical, insulation, drywall, finishes, and a final inspection. Each stage has an inspection that must pass before the work gets covered, and that sequence sets the pace of the whole build [1]. For planning, the construction phase of a detached unit typically runs about 4 to 8 months once the permit is issued. Here is what happens in each stage, and the material decisions that matter most for a small home in the Pacific Northwest." },
      { type: "h2", text: "Before the build: siting and the permit" },
      { type: "p", text: "Where the unit sits drives cost as much as its size. In Vancouver a detached ADU has to be at least 10 feet from other structures, or add sprinklers or fire-rated construction [2], and ADUs in both Vancouver and unincorporated Clark County are generally capped at 1,000 square feet [2][3]. Distance from the street and the main house also sets how far water, sewer, and power have to be trenched. For the full design and permit side, see our step-by-step ADU process guide." },
      { type: "h2", text: "Stage 1: Site work and foundation (about 3 to 6 weeks)" },
      { type: "p", text: "Erosion control goes in first and is itself inspected. Then excavation, utility trenching, footings, and the foundation. Inspectors check the setbacks and footing steel before concrete is poured, and footing drains and stormwater work before backfill [1]." },
      { type: "p", text: "Material choice: slab-on-grade or crawlspace. A slab keeps the unit low to the ground, which suits a single-level, accessible design. A crawlspace raises the floor and leaves access to plumbing and ducts underneath, and takes more material and more steps on the site. On a sloped lot the decision often makes itself." },
      { type: "h2", text: "Stage 2: Framing, roof, and dry-in (about 3 to 6 weeks)" },
      { type: "p", text: "Floor framing, walls, and roof go up, then sheathing, roofing, windows, and doors until the unit is weather-tight. Floor framing and shear walls (the braced walls that resist wind and earthquakes) are inspected along the way [1]. In our climate the goal is to reach dry-in fast, because every week the frame is open to rain is a week of risk to everything that follows." },
      { type: "ul", items: [
        "Roofing: architectural composition shingles are the common choice; standing-seam metal costs more up front and lasts longer",
        "Siding: fiber cement lap siding is popular in the Northwest because it does not rot the way wood can; real wood looks great and needs more upkeep",
        "Windows: they have to meet the energy code values on the window schedule submitted with the permit [4], so choose them during design, not after",
      ] },
      { type: "h2", text: "Stage 3: Rough-ins (about 2 to 4 weeks)" },
      { type: "p", text: "Rough plumbing and mechanical are inspected, and rough electrical must be complete before the framing inspection [1]. Decide now where every outlet, light, and appliance goes, because changing them after drywall is expensive." },
      { type: "p", text: "Material choice: heating. Washington's current residential energy code no longer mandates heat pumps for space heating [5], but new homes have to earn energy credits [5], and efficient heating is one of the common ways to earn them. For a small unit, a ductless heat pump is a popular choice because it heats and cools efficiently, and Vancouver requires each unit to have its own temperature control anyway [2]." },
      { type: "h2", text: "Stage 4: Insulation and drywall (about 2 to 4 weeks)" },
      { type: "p", text: "Insulation is inspected before it is covered [1]. A small home with a well-sealed, well-insulated shell costs little to heat for decades, so this is not the place to cut. Then drywall, and the drywall nailing inspection." },
      { type: "h2", text: "Stage 5: Finishes and exterior (about 4 to 8 weeks)" },
      { type: "p", text: "Cabinets, counters, flooring, tile, trim, doors, paint, and fixtures inside; siding details, trim, gutters, and final grading outside. In a rental unit, durable finishes pay for themselves: luxury vinyl plank or tile over carpet in wet areas, quartz or solid-surface counters, and semi-gloss paint on trim." },
      { type: "p", text: "Late finish decisions are the most common cause of delay at this stage. Make selections during design and confirm them before construction starts." },
      { type: "h2", text: "Stage 6: Final inspection and occupancy (about 1 to 2 weeks)" },
      { type: "p", text: "The final inspection closes the permit, and in unincorporated Clark County an ADU needs a Certificate of Occupancy before anyone moves in [3]. Get copies of everything: the permit record, warranties, appliance manuals, and a record of what is behind the walls." },
      { type: "h2", text: "How we build it" },
      { type: "p", text: "We run a detached ADU as one accountable project with one point of contact, a written schedule, and a walkthrough at each milestone. And because a rental unit is an asset for decades, we build it to be maintained, then keep it maintained through the 360 Method." },
      { type: "cta", text: "Planning a backyard ADU? We will walk your lot, map the utilities, and give you a realistic scope before design begins.", ctaLabel: "See Detached ADUs", ctaAction: "link", ctaHref: "/services/detached-adu" },
    ],
    references: [
      { label: "Clark County, Typical New Home and Remodel Inspections", url: "https://clark.wa.gov/community-development/typical-new-home-and-remodel-inspections" },
      { label: "City of Vancouver, Accessory Dwelling Units", url: "https://www.cityofvancouver.us/business/building-construction/residential-building-permits/accessory-dwelling-units/" },
      { label: "Clark County, Accessory Dwelling Unit (urban)", url: "https://clark.wa.gov/community-development/accessory-dwelling-unit-urban" },
      { label: "Clark County, Residential Building Permit Application Packet and Checklists", url: "https://clark.wa.gov/sites/default/files/media/document/2022-09/res-app-and-checklists.pdf" },
      { label: "Washington State Building Code Council, 2021 Washington State Energy Code, Residential", url: "https://sbcc.wa.gov/sites/default/files/2024-10/2021%20WSEC_R%20_Sept2024.pdf" },
    ],
  },

  {
    slug: "home-addition-process-clark-county",
    title: "How a Home Addition Works in Clark County: Permits, Timeline, and What You Decide",
    excerpt: "An addition is new construction attached to a home you live in. Here is the process step by step, what the permit requires, how long to plan for, and how to keep living in the house while it happens.",
    date: "September 24, 2026",
    isoDate: "2026-09-24",
    publishDate: "2026-09-24",
    author: "Marcin Micek | Handy Pioneers",
    category: "ADUs & Additions",
    audience: ["Homeowners"],
    tags: ["home addition Vancouver WA", "home addition Clark County", "addition permit", "room addition", "primary suite addition"],
    image: "https://handypioneers.com/images/blog/home-addition-process-clark-county.webp",
    imageAlt: "A new room addition framed onto the side of a Pacific Northwest house, with the new roof tied into the old",
    readTime: 7,
    seoTitle: "Home Addition Process in Clark County, WA: Permits, Timeline & Steps | Handy Pioneers",
    seoDesc: "How a home addition works in Vancouver and Clark County, WA: feasibility, design, the permit and plan set, construction sequence, inspections, and a realistic timeline.",
    body: [
      { type: "p", text: "A home addition in Clark County follows six steps: a feasibility check, design and a permit-ready plan set, permit review, a fixed contract, construction with inspections, and a final sign-off. For planning, most additions take roughly 6 to 12 months from first walkthrough to move-in, with 3 to 6 months of that being construction. Every addition needs a residential building permit. In Vancouver the application includes a stormwater form, energy code compliance, lateral bracing or engineering, and a full plan set [1]; in unincorporated Clark County, additions fall under the Additional Dwelling or Structure (ADS) permit [2]." },
      { type: "h2", text: "Step 1: Feasibility (1 to 3 weeks)" },
      { type: "p", text: "Start with what the new space has to do. Sometimes the honest answer is a remodel, not an addition: removing a wall or finishing a basement can solve the problem with no new foundation. When you truly need more square footage, the feasibility check covers setbacks and zoning for your lot, how the new roof will meet the existing one, and what the existing foundation and framing can support." },
      { type: "h2", text: "Step 2: Plans and engineering (4 to 8 weeks)" },
      { type: "p", text: "An architect or residential designer draws the permit plans, with structural engineering for the foundation and the roof tie-in. We do not draw plans or do engineering in-house, and we recommend having them done first. Vancouver's addition checklist calls for a site plan, floor plan, foundation plan, framing plans, wall sections, and elevations, along with the energy code paperwork and the stormwater form [1]. Additions larger than 150 square feet also have to earn energy credits under the Washington State Energy Code, which shapes insulation, windows, and heating choices [3]." },
      { type: "p", text: "The most important design decision is the one people see: how the addition meets the house. Matching the roof pitch, siding, trim, and window style is what makes an addition look original rather than added." },
      { type: "h2", text: "Step 3: Permit review (1 to 3 months)" },
      { type: "p", text: "The plan set goes to your city or the county. Vancouver reviews in five steps, from submittal and prescreen through plan review, approval, and issuance [4]. State law gives local governments 65 days to decide a complete application that needs no public notice [5]. The best way to keep it moving is to submit it complete the first time." },
      { type: "h2", text: "Step 4: Fixed scope and contract (1 to 2 weeks)" },
      { type: "p", text: "Price from the approved drawings, a written scope, payments tied to milestones, and a start date. Order windows and anything special-order right away." },
      { type: "h2", text: "Step 5: Construction and inspections (3 to 6 months)" },
      { type: "p", text: "The sequence matters more on an addition than anywhere else, because your home gets opened up to the weather. The right order:" },
      { type: "ol", items: [
        "Foundation for the new space, with the footing inspection before concrete",
        "Framing, sheathing, and the roof tie-in, so the new structure is weather-tight",
        "Break through into the existing house as late as practical, keeping dust and rain out",
        "Rough plumbing, mechanical, and electrical, each inspected",
        "Insulation (inspected), drywall, and finishes",
      ] },
      { type: "p", text: "Clark County's typical inspection list runs from footings and framing through insulation, drywall nailing, and final [6]. Most families live in the house throughout. Expect noise and restricted access near the work area, and plan around the day the wall comes down." },
      { type: "h2", text: "Step 6: Final inspection and handoff (1 to 2 weeks)" },
      { type: "p", text: "The final inspection closes the permit. Keep the permit record and warranties; an addition that was permitted and inspected is worth its full value at resale." },
      { type: "h2", text: "Addition or ADU?" },
      { type: "p", text: "An addition makes the main house bigger. If the new space needs its own kitchen, bathroom, and entrance, for a parent or a renter, it may be an attached ADU instead, which has its own rules and, in many cases, reduced impact fees. We help you compare both on the walkthrough." },
      { type: "cta", text: "Need more room? We will walk the house, tell you whether an addition or a remodel is the better answer, and lay out the plan.", ctaLabel: "See Home Additions", ctaAction: "link", ctaHref: "/services/home-additions" },
    ],
    references: [
      ...
      { label: "Clark County, Residential Permits", url: "https://clark.wa.gov/community-development/residential-permits" },
      { label: "Washington State Building Code Council, 2021 Washington State Energy Code, Residential", url: "https://sbcc.wa.gov/sites/default/files/2024-10/2021%20WSEC_R%20_Sept2024.pdf" },
      { label: "City of Vancouver, Residential Building Permits", url: "https://www.cityofvancouver.us/business/building-construction/residential-building-permits/" },
      { label: "Washington State Legislature, RCW 36.70B.080 (permit review time limits)", url: "https://app.leg.wa.gov/rcw/default.aspx?cite=36.70b.080" },
      { label: "Clark County, Typical New Home and Remodel Inspections", url: "https://clark.wa.gov/community-development/typical-new-home-and-remodel-inspections" },
  ...
  {
    slug: "interior-carpentry-wet-season-pnw",
    title: "Why Fall and Winter Are the Right Time for Interior Carpentry in the Pacific Northwest",
    excerpt: "Rain stops exterior work, not interior work. Trim, wainscoting, built-ins, and cabinet installation happen indoors, which makes October through March a practical window, as long as the wood gets time to adjust to your heated home first.",
    ...
    audience: ["Homeowners"],
    tags: ["finish carpentry Vancouver WA", "interior carpentry", "winter home projects", "trim installation", "wood acclimation"],
    image: "https://handypioneers.com/images/blog/interior-carpentry-wet-season-pnw.webp",
    imageAlt: "Rain on a window beside freshly installed white interior trim and a warm lamp-lit room",
    readTime: 5,
    seoTitle: "Why Fall and Winter Are the Best Time for Interior Carpentry in Clark County, WA | Handy Pioneers",
    seoDesc: "Rain stops decks and paint, not trim and built-ins. Why the wet season is a practical time for interior carpentry in Clark County, and why wood needs to acclimate before it goes up.",
    body: [
      { type: "p", text: "Yes, fall and winter are a good time for interior carpentry here. Rain shuts down exterior painting, deck work, and roofing for months in Clark County, but trim, wainscoting, built-in shelving, and cabinet installation all happen inside, so the weather does not touch the schedule. The one thing the season does change is the wood itself. Heated winter air is drier, and wood trim takes on or gives up moisture to match the air around it [1]. Good carpentry in winter means giving the material time to adjust to your home before it goes on the wall." },
      { type: "h2", text: "Why the calendar favors indoor work now" },
      { type: "p", text: "From spring through early fall, most homeowners in Vancouver, Camas, and Washougal are focused outside: decks, paint, gutters, moss. That is the right order, because exterior work needs dry weather. Once the rain settles in, the list moves indoors, and the projects that have been waiting for an open weekend (the plain dining room, the builder-grade baseboard, the empty wall that should be a bookcase) finally get their turn." },
      { type: "p", text: "There is a practical upside too. Holiday gatherings put the inside of the house on display. A room with new trim, paneling, or built-ins finished in November is a room you enjoy all winter." },
      { type: "h2", text: "What happens to wood when the heat comes on" },
      { type: "p", text: "Wood is hygroscopic: it takes on moisture from the air around it and gives it back as the air dries [2]. The USDA Forest Products Laboratory's Wood Handbook shows how directly this tracks humidity. At 70°F, wood in 50% relative humidity settles around 9% moisture content, while wood in 30% humidity settles near 6% [2]. When your furnace runs on a cold, damp day, indoor humidity drops, and trim, paneling, and shelving slowly dry and shrink to match." },
      { type: "p", text: "The same handbook recommends that interior woodwork and trim be installed at the moisture content it will live at, about 8% on average for most of the country, with a range of 6 to 10% for individual pieces [1]. Install trim that is still carrying moisture from a cold warehouse or a damp garage, and it shrinks after it is nailed up. That is how you get open miters, gaps at the baseboard, and hairline cracks in paint along panel edges by February." },
      { type: "h2", text: "How we handle it" },
      { type: "ul", items: [
        "Material is delivered into the room where it will be installed, not stored in a garage or on a concrete floor. Moulding manufacturers call for the same thing: lay it out in the room and let it acclimate before installation [3].",
        "The heat stays on at normal living temperature while the material adjusts and while we work, so the wood reaches the conditions it will actually live in.",
        "Joints are glued and fastened, and caulk goes on after the material has settled, not before.",
        "We schedule the finish coat of paint after installation, so any small movement shows up before the final coat, not after.",
      ] },
      { type: "h2", text: "Projects that fit the wet season" },
      { type: "ul", items: [
        "New baseboard, door casing, and crown molding in the main living areas",
        "Wainscoting or board and batten in a dining room, entry, or stairway",
        "Built-in bookcases, window seats, and mudroom benches",
        "Installing cabinets your designer has ordered for a kitchen, laundry, or pantry",
        "Interior door replacement and adjustment, since doors that swell in fall are easy to spot now",
      ] },
      { type: "p", text: "If you are working with an interior designer, this is also the season when their plans tend to be ready. Bringing a carpenter in early, while drawings are final and before materials ship, keeps the project on schedule." },
      { type: "cta", text: "Planning trim, paneling, built-ins, or a cabinet install this winter? We will walk the space and put a written scope in front of you.", ctaLabel: "See Finish Carpentry", ctaAction: "link", ctaHref: "/services/carpentry-trim" },
    ],
    references: [
      { label: "USDA Forest Products Laboratory, Wood Handbook (FPL-GTR-282), Chapter 13: Drying and Control of Moisture Content and Dimensional Changes", url: "https://www.fpl.fs.usda.gov/documnts/fplgtr/fplgtr282/chapter_13_fpl_gtr282.pdf" },
      { label: "USDA Forest Products Laboratory, Wood Handbook (FPL-GTR-282), Chapter 4: Moisture Relations and Physical Properties of Wood", url: "https://www.fpl.fs.usda.gov/documnts/fplgtr/fplgtr282/chapter_04_fpl_gtr282.pdf" },
      { label: "ARAUCO, MDF Moulding Installation Instructions", url: "https://na.arauco.com/fr/resources/download/MDFMoulding_Installation_Instructions_v1" },
    ],
  },

  {
    slug: "wainscoting-vs-board-and-batten-vs-shiplap",
    title: "Wainscoting vs. Board and Batten vs. Shiplap: Which Fits Your Home?",
    excerpt: "Three wall treatments that get lumped together, with very different looks. Here is what each one is, where it works, and how to choose for a Clark County home.",
    ...
    category: "Interior Carpentry",
    audience: ["Homeowners"],
    tags: ["wainscoting Vancouver WA", "board and batten", "shiplap", "wall paneling", "dining room ideas"],
    ...
    readTime: 5,
    seoTitle: "Wainscoting vs Board and Batten vs Shiplap: How to Choose | Handy Pioneers, Clark County WA",
    seoDesc: "Wainscoting, board and batten, and shiplap compared: what each looks like, where each works, and how to pick the right wall treatment for your home in Clark County, WA.",
    body: [
      { type: "p", text: "Wainscoting is paneling on the lower part of a wall, traditionally framed panels under a chair rail. Board and batten is flat paneling with vertical strips over the seams, forming a simple grid. Shiplap is horizontal boards with a small shadow gap between them. All three add depth and durability to a plain wall, but they send very different signals. Wainscoting reads traditional and formal, board and batten reads clean and crafted, and shiplap reads relaxed and farmhouse. The right one depends on the age and style of your house and the room it goes in." },
      { type: "h2", text: "Wainscoting" },
      { type: "p", text: "Classic wainscoting is a series of framed panels, either raised (the panel center stands proud) or recessed (a flat panel sits inside a frame), capped with a chair rail. It belongs in dining rooms, entries, and stairways, and it suits older homes and more formal interiors. Picture-frame molding, where applied trim boxes form panels directly on the drywall, gives a similar look with less material." },
      { type: "p", text: "Wainscoting takes the most layout work of the three. Panels need to be spaced so they land evenly between corners, doors, windows, and outlets. A room where the last panel is a sliver next to the door frame looks wrong even to people who cannot say why." },
      { type: "h2", text: "Board and batten" },
      { type: "p", text: "Board and batten uses a smooth panel with vertical battens spaced evenly across it, usually topped with a ledge or cap. It can run a third of the way up the wall, two thirds, or floor to ceiling. It works in mudrooms, hallways, bedrooms, and newer homes that want some character without formality. It pairs well with the craftsman and modern farmhouse styles common in newer Clark County neighborhoods." },
      { type: "h2", text: "Shiplap" },
      { type: "p", text: "Shiplap is horizontal boards with a gap between each one. It usually covers a full wall, often as an accent behind a bed, a fireplace, or a range hood. It is more casual than the other two and fits cottages, cabins, and farmhouse-style interiors. Painted white it is bright and simple; stained it feels warmer and more rustic." },
      { type: "h2", text: "How to choose" },
      { type: "ul", items: [
        "Match the house. A 1920s bungalow near downtown Vancouver takes traditional wainscoting well. A 2010s build on Prune Hill often looks better with board and batten.",
        "Match the room. Formal rooms take framed panels. Working rooms (mudrooms, laundry, kids' spaces) take board and batten, which is easy to wipe down.",
        "Mind the height. Many rooms look right with paneling around a third of the wall height, and taller treatments suit high ceilings. We tape the height on your wall so you can see it before we build.",
        "Think about moisture. In bathrooms and mudrooms, we use moisture-resistant materials and seal every edge.",
        "Plan the outlets. Paneling thickens the wall, so outlet and switch boxes need extenders to sit flush.",
      ] },
      { type: "p", text: "If you have an interior designer, they have likely already chosen the style. Our job is to lay it out so it fits your actual room and build it clean. If you do not, we are glad to bring samples and help you decide on site." },
      { type: "cta", text: "Considering wainscoting, board and batten, or shiplap? We will lay out the room and show you the height before anything goes up.", ctaLabel: "See Wainscoting Services", ctaAction: "link", ctaHref: "/services/wainscoting" },
    ],
  },

  {
    slug: "working-with-interior-designer-and-carpenter",
    title: "Working With an Interior Designer and a Carpenter: Who Does What",
    excerpt: "Your designer has the vision. Your carpenter has to make it fit real walls. Here is how the handoff works when it goes well, and what to settle before work starts.",
    ...
    category: "Interior Carpentry",
    audience: ["Homeowners"],
    tags: ["interior designer", "finish carpenter Vancouver WA", "contractor and designer", "built-ins", "cabinet installation"],
    image: "https://handypioneers.com/images/blog/working-with-interior-designer-and-carpenter.webp",
    imageAlt: "Design drawings, paint swatches, and a trim sample laid out on a table in a home under renovation",
    readTime: 5,
    seoTitle: "Interior Designer and Carpenter: Who Does What on a Home Project | Handy Pioneers",
    seoDesc: "How an interior designer and a finish carpenter split the work on trim, built-ins, and cabinets, and the five things to settle before the project starts. Clark County, WA.",
    body: [
      { type: "p", text: "The interior designer decides what the room should look like and how it should work. The carpenter decides how to build it so it fits the actual walls, floors, and framing, and then builds it. When both roles are clear, the project goes smoothly. When they blur, you get a built-in that is two inches too wide for the alcove, or crown molding that was ordered before anyone checked the ceiling. The homeowner's job is to make sure the two talk before materials are ordered." },
      { type: "h2", text: "What your designer owns" },
      { type: "ul", items: [
        "The look: style, profiles, colors, finishes, and hardware",
        "The layout: what goes where and how the room is used",
        "Selections: cabinet line, paneling style, trim profiles, paint",
        "Drawings and elevations that show the intent",
      ] },
      { type: "h2", text: "What your carpenter owns" },
      { type: "ul", items: [
        "Measuring the real room and flagging where it differs from the drawing",
        "Telling you what the walls, floors, and framing will and will not allow",
        "Material quantities, acclimation, and install sequence",
        "The build itself: joints, reveals, scribing to uneven walls, and a paint-ready finish",
        "Coordinating with the other trades when electrical or plumbing is involved",
      ] },
      { type: "h2", text: "Where projects go wrong" },
      { type: "p", text: "Almost always at the handoff. A drawing shows a perfectly square alcove; the real one is out of plumb by half an inch over eight feet. A cabinet order assumes a level floor; the kitchen floor drops toward the back door. None of this is anyone's fault. Houses are not built to drawing tolerances, especially older ones. The fix is simple: the carpenter should measure and review the plan before anything is ordered or cut." },
      { type: "h2", text: "Five things to settle before work starts" },
      { type: "ol", items: [
        "Who orders materials. Designer, homeowner, or carpenter. Decide it, write it down.",
        "Who approves field changes. When the room does not match the drawing, who makes the call, and how fast.",
        "Finish responsibility. Does the carpenter leave it paint-ready, or paint it too? Who does touch-up?",
        "Schedule and sequence. Trim after flooring, cabinets before counters, paint after trim. One calendar, shared.",
        "One point of contact on each side, so questions do not bounce around.",
      ] },
      { type: "p", text: "This is how we work with designers on trim, wainscoting, built-ins, and cabinet installation. We review the drawings, walk the space, send back any questions in writing, and then build to the plan. The designer stays in charge of the look. We are responsible for how it is built." },
      { type: "cta", text: "Have a designer's plan ready for trim, built-ins, or cabinets? Send it over and we will walk the space.", ctaLabel: "See Finish Carpentry", ctaAction: "link", ctaHref: "/services/carpentry-trim" },
    ],
  },

  {
    slug: "what-drives-cost-of-built-in-shelving",
    title: "What Drives the Cost of Built-In Shelving",
    excerpt: "Two built-ins that look alike in a photo can differ a lot in price. Here are the factors that actually move the number, so you can plan the one you want.",
    date: "October 2, 2026",
    isoDate: "2026-10-02",
    ...
    category: "Interior Carpentry",
    audience: ["Homeowners"],
    tags: ["built-in shelving cost", "built-in bookcase Vancouver WA", "custom shelving", "built-ins"],
    ...
    readTime: 5,
    seoTitle: "What Drives the Cost of Built-In Shelving and Bookcases | Handy Pioneers, Vancouver WA",
    seoDesc: "Size, doors and drawers, paint-grade vs stain-grade, the wall it goes on, and finish: the factors that set the price of a built-in bookcase or shelving unit.",
    body: [
      { type: "p", text: "The price of a built-in comes down to five things: its size, how much of it is closed storage (doors and drawers) versus open shelves, whether it is paint-grade or stain-grade, how difficult the wall is, and who does the finish. A simple set of painted open shelves in a square alcove sits at one end. A floor-to-ceiling stain-grade library wall with lower cabinets, lighting, and a rolling ladder sits at the other. We will not quote a number sight unseen, because the wall matters as much as the design, but here is what moves the price so you can plan." },
      { type: "h2", text: "1. Size and shape" },
      { type: "p", text: "Linear feet and height are the starting point. Floor to ceiling costs more than a half-height unit, both in material and in the work of scribing the top to a ceiling that is rarely level. Corners, returns, and units that wrap a window or fireplace add joinery." },
      { type: "h2", text: "2. Open shelves versus doors and drawers" },
      { type: "p", text: "Open shelving is the simplest. Every door adds hinges, fitting, and alignment; every drawer adds a box and slides. A common and good-looking middle ground is closed cabinets below, open shelves above." },
      { type: "h2", text: "3. Paint-grade or stain-grade" },
      { type: "p", text: "Paint-grade built-ins use stable sheet goods and poplar or MDF trim that paint beautifully and stay flat. Stain-grade uses hardwood plywood and solid hardwood throughout, and every joint and grain match shows, so it takes more material and more careful work." },
      { type: "h2", text: "4. The wall and the room" },
      { type: "p", text: "Walls that are out of plumb, floors that slope, baseboard and outlets that have to be worked around, a heat register in the way: all of it adds fitting time. Older homes usually need more scribing than new ones. This is the part no one can price from a photo." },
      { type: "h2", text: "5. Shelf span and load" },
      { type: "p", text: "Books are heavy, and wood under a constant load keeps bending slowly over the years. The USDA Wood Handbook calls this creep, and notes that after several years the extra sag can roughly equal the initial bend [1]. Long, thin shelves bow. We size span and thickness for what the shelf will hold, and add a face frame or hidden support where it is needed. It adds a little cost now and saves a sagging shelf later." },
      { type: "h2", text: "6. Extras" },
      { type: "ul", items: [
        "Integrated lighting (the wiring itself is done by a licensed electrician)",
        "Glass doors, specialty hardware, or a library ladder",
        "Cable management for a media wall",
        "Painting on site versus leaving it paint-ready for your painter",
      ] },
      { type: "p", text: "The best way to get a real number is a walkthrough. We measure the wall, look at what is behind and around it, talk through the design (or review your designer's), and give you a written scope and price." },
      { type: "cta", text: "Thinking about a built-in bookcase, window seat, or media wall? We will measure it and give you a written price.", ctaLabel: "See Built-In Shelving", ctaAction: "link", ctaHref: "/services/built-ins" },
    ],
    references: [
      { label: "USDA Forest Products Laboratory, Wood Handbook (FPL-GTR-282), Chapter 5: Mechanical Properties of Wood (Creep and Relaxation)", url: "https://www.fpl.fs.usda.gov/documnts/fplgtr/fplgtr282/chapter_05_fpl_gtr282.pdf" },
    ],
  },

  {
    slug: "paint-grade-vs-stain-grade-trim",
    title: "Paint-Grade vs. Stain-Grade Trim: MDF, Poplar, or Oak?",
    excerpt: "The trim material matters less than matching it to the finish and the room. Here is how MDF, poplar, and oak compare, and where each one belongs.",
    date: "October 6, 2026",
    isoDate: "2026-10-06",
    ...
    category: "Interior Carpentry",
    audience: ["Homeowners"],
    tags: ["MDF trim", "poplar trim", "oak trim", "baseboard", "trim installation Vancouver WA"],
    image: "https://handypioneers.com/images/blog/paint-grade-vs-stain-grade-trim.webp",
    imageAlt: "Samples of painted MDF, poplar, and stained oak trim profiles laid side by side on a workbench",
    readTime: 5,
    seoTitle: "Paint-Grade vs Stain-Grade Trim: MDF, Poplar, or Oak? | Handy Pioneers",
    seoDesc: "MDF, poplar, and oak trim compared: cost, durability, how each takes paint or stain, and where each one belongs in a Clark County home.",
    body: [
      { type: "p", text: "If the trim will be painted, MDF or poplar. If it will be stained, a hardwood like oak. That is the short answer. MDF is smooth, stable, and economical, and it paints beautifully, but it dents more easily and does not tolerate standing water. Poplar is a real hardwood that paints well and holds up better to bumps. Oak and other stain-grade hardwoods cost more and show every joint, because the grain is the finish. Most homes use a mix, chosen room by room." },
      { type: "h2", text: "MDF" },
      { type: "p", text: "Medium-density fiberboard is made from wood fibers and resin pressed into a uniform board. It has no grain and no knots, so it takes paint smoothly, and it moves less with humidity than solid wood. It is the most common trim material in newer homes." },
      { type: "ul", items: [
        "Best for: painted baseboard, casing, and crown in dry living spaces",
        "Watch out for: bathrooms, mudrooms, and anywhere a mop or wet boots meet the baseboard. Unsealed MDF swells when it gets wet.",
        "Acclimate it anyway. MDF moulding manufacturers still call for laying it out in the room before installation [1].",
      ] },
      { type: "p", text: "Composite wood products sold in the US, including MDF, must meet federal formaldehyde emission limits under the Toxic Substances Control Act Title VI, and carry a compliance label [2]." },
      { type: "h2", text: "Poplar" },
      { type: "p", text: "Poplar is a hardwood with a fine, even grain that paints well. It is tougher than MDF, holds a sharp profile edge, and handles moisture better, so it is a good upgrade in high-traffic rooms and a sound choice for built-ins and wainscoting caps." },
      { type: "ul", items: [
        "Best for: painted trim in busy rooms, stair skirts, built-in face frames, window stools",
        "Watch out for: green or dark streaks in the wood, which is why it is painted, not stained",
      ] },
      { type: "h2", text: "Oak and other stain-grade hardwoods" },
      { type: "p", text: "Red and white oak, maple, cherry, and fir are chosen when you want the wood itself to show. Many older Clark County homes have original fir or oak trim worth keeping, and matching it is often better than replacing it." },
      { type: "ul", items: [
        "Best for: homes with existing stained trim, craftsman and traditional interiors, stain-grade built-ins",
        "Watch out for: joints. Paint hides small gaps; stain shows everything. Stain-grade work takes more careful fitting.",
      ] },
      { type: "h2", text: "Mixing materials" },
      { type: "p", text: "A practical plan: MDF in bedrooms and living areas, poplar in the entry and mudroom and anywhere that takes abuse, and moisture-resistant material in bathrooms. Painted, no one can tell them apart. If you are matching existing stained trim, we will tell you up front where an exact match is possible and where it is not." },
      { type: "cta", text: "Replacing baseboard and casing, or matching trim you already have? We will walk you through the options on site.", ctaLabel: "See Finish Carpentry", ctaAction: "link", ctaHref: "/services/carpentry-trim" },
    ],
    references: [
      { label: "ARAUCO, MDF Moulding Installation Instructions", url: "https://na.arauco.com/fr/resources/download/MDFMoulding_Installation_Instructions_v1" },
      { label: "U.S. EPA, Formaldehyde Emission Standards for Composite Wood Products (TSCA Title VI)", url: "https://www.epa.gov/formaldehyde/formaldehyde-emission-standards-composite-wood-products" },
    ],
  },

  {
    slug: "designer-ordered-cabinets-what-installation-involves",
    title: "Your Designer Ordered the Cabinets. What Installation Actually Involves",
    excerpt: "The cabinets are chosen and on order. Here is what a good installation looks like, step by step, and what to check before install day.",
    date: "October 9, 2026",
    isoDate: "2026-10-09",
    ...
    category: "Interior Carpentry",
    audience: ["Homeowners"],
    tags: ["cabinet installation Vancouver WA", "kitchen cabinets", "cabinet installer", "interior designer"],
    ...
    readTime: 6,
    seoTitle: "Cabinet Installation: What to Expect When Your Designer Ordered the Cabinets | Handy Pioneers",
    seoDesc: "What a professional cabinet installation involves after your designer places the order: delivery check, level line, fastening to studs, scribing, crown, and hardware. Clark County, WA.",
    body: [
      { type: "p", text: "A professional cabinet installation has six parts: checking the delivery against the plan, finding the high point of the floor and setting a level line, fastening every cabinet into the wall framing, shimming and scribing to walls and floors that are not straight, adding the trim (fillers, end panels, crown, toe kick), and aligning doors and drawers before hardware goes on. Manufacturers are clear about the basics: cabinets must be level, plumb, and square, shimmed where the floor or wall is uneven, and screwed into studs, never hung with nails or drywall screws [1]. Everything else is the craft of making an imperfect room disappear." },
      { type: "h2", text: "Before install day" },
      { type: "ul", items: [
        "Review the layout against the room. We measure and compare to the designer's plan before delivery, so any conflict with a window, vent, or outlet is caught while it can still be fixed.",
        "Check the delivery. Every box is opened and checked against the order. Missing, wrong, or damaged pieces get reported to the supplier right away, not discovered halfway through the install.",
        "Confirm the sequence. Flooring, plumbing and electrical rough-in, and any wall repair come first. Countertop templating comes after cabinets are set.",
        "Clear the room and plan for water. If the sink is out, you will be without a kitchen sink for a while. Plan for it.",
      ] },
      { type: "h2", text: "Install day, step by step" },
      { type: "ol", items: [
        "Find the high point. Floors are rarely level. We find the highest spot and set every base cabinet to a line from there, shimming the rest up to it.",
        "Hang the uppers or set the bases, depending on the layout. Both are fastened through their mounting rails into studs.",
        "Join the boxes. Adjacent cabinets are clamped and screwed together so faces are flush and gaps are even.",
        "Scribe the fillers and end panels. Where a cabinet meets a wall that is not straight, the filler is cut to follow the wall so there is no visible gap.",
        "Trim out. Crown, light rail, toe kick, and any decorative panels go on.",
        "Adjust and finish. Doors and drawers are aligned so gaps are even across the run, then hardware is installed from a template so every pull lines up.",
      ] },
      { type: "h2", text: "What to look for when it is done" },
      { type: "ul", items: [
        "Door gaps that are even across the whole run",
        "Crown that meets the ceiling cleanly, or a consistent reveal if it does not go all the way up",
        "No visible shims, screws, or gaps at the walls",
        "Drawers that close fully without rubbing",
        "Tops that are flat and level, ready for the countertop template",
      ] },
      { type: "h2", text: "Permits" },
      { type: "p", text: "In unincorporated Clark County, cabinets, countertops, and similar finish work are listed as not requiring a building permit, though the work still has to meet code [2]. If your project moves plumbing, electrical, or walls, those parts can need permits. Check with your city if you are inside Vancouver, Camas, or another city's limits; we tell you what applies before work starts." },
      { type: "p", text: "To be clear about our role: we install cabinets you or your designer supply. We do not manufacture them. That keeps the choice of cabinet line with you and your designer, and keeps our job focused on making it fit." },
      { type: "cta", text: "Cabinets on order? Send us the layout and we will review it before delivery.", ctaLabel: "See Cabinet Installation", ctaAction: "link", ctaHref: "/services/cabinet-installation" },
    ],
    references: [
      { label: "KlearVue Cabinetry, Installation Guide", url: "https://www.klearvuecabinetry.com/KlearvueWebsite/web/cms/docs/KlearvueInstallationGuide.pdf" },
      { label: "Clark County, WA, Residential Permits (work not requiring a permit)", url: "https://clark.wa.gov/community-development/residential-permits" },
    ],
  },

  {
    slug: "built-ins-that-add-storage",
    title: "Built-Ins That Add Storage: Mudroom Benches, Window Seats, and Media Walls",
    excerpt: "The best built-ins solve a daily problem: the pile of shoes by the door, the TV cords, the wasted bay window. Here are five that earn their space.",
    ...
    category: "Interior Carpentry",
    audience: ["Homeowners"],
    tags: ["mudroom bench", "window seat", "media wall", "built-in storage", "built-ins Vancouver WA"],
    image: "https://handypioneers.com/images/blog/built-ins-that-add-storage.webp",
    imageAlt: "A painted mudroom bench with coat hooks and rain boots beside an entry door on a rainy day",
    readTime: 5,
    seoTitle: "Built-Ins That Add Storage: Mudroom Benches, Window Seats, Media Walls | Handy Pioneers",
    seoDesc: "Five built-ins that add real storage to a Clark County home: mudroom benches, window seats, media walls, fireplace bookcases, and under-stair storage.",
    body: [
      { type: "p", text: "The built-ins that add the most storage are the ones that solve a problem you deal with every day. In most homes that means five places: a mudroom or entry bench for shoes, coats, and bags; a window seat with storage underneath; a media wall that hides the cords and electronics; bookcases on either side of a fireplace; and the dead space under a staircase. Each turns wasted or cluttered space into something useful, and done right, each looks like it came with the house." },
      { type: "h2", text: "1. The mudroom or entry bench" },
      { type: "p", text: "In a region with eight months of rain, the entry takes a beating. A built-in bench with cubbies or drawers below, hooks above, and an upper shelf for baskets gives every person a spot. Use durable, moisture-resistant materials near the floor, and a finish that wipes clean." },
      { type: "h2", text: "2. The window seat" },
      { type: "p", text: "Bay windows and bump-outs are often the most underused spots in a house. A window seat with lift-top storage or drawers holds blankets, toys, or out-of-season gear, and it becomes the favorite seat in the room. Plan for the heat register if there is one below the window; it may need to be rerouted through the face of the seat." },
      { type: "h2", text: "3. The media wall" },
      { type: "p", text: "A built-in around the TV hides the components, routes the cables inside the wall or cabinet, and gives the room a finished focal point instead of a black rectangle on a bare wall. Plan ventilation for the electronics and access to the back for future changes. New outlets or low-voltage runs are handled by a licensed electrician." },
      { type: "h2", text: "4. Fireplace bookcases" },
      { type: "p", text: "The alcoves beside a fireplace are made for bookcases. Closed cabinets below and open shelves above is the classic layout. Keep the required clearances from the firebox; your fireplace's manufacturer and local code set them." },
      { type: "h2", text: "5. Under the stairs" },
      { type: "p", text: "The triangle under a staircase can hold pull-out drawers, a coat closet, or open shelving. It takes careful measuring because every piece is a different height, which is exactly the kind of work a site-built piece handles better than anything off the shelf." },
      { type: "h2", text: "What makes a built-in look original" },
      { type: "ul", items: [
        "It is scribed to the wall, not pushed against it",
        "Its trim matches the room's baseboard, casing, and crown",
        "Shelves are sized so they do not sag",
        "The paint or stain matches the surrounding trim",
      ] },
      { type: "cta", text: "Have a spot that needs a bench, a window seat, or a media wall? We build them on site to fit.", ctaLabel: "See Built-In Shelving", ctaAction: "link", ctaHref: "/services/built-ins" },
    ],
  },
...

  {
    ...
    "body": [
      ...
      { "type": "p", "text": "We start with a feasibility and zoning check for your address, so you hire a designer knowing what your lot allows. We do not draw plans or do structural engineering in-house; we recommend having those done first, then we review the drawings for buildability and cost and build the unit as one accountable engagement, with one point of contact from permit issuance to final inspection." },
  ...
  },
  {
    ...
    "title": "Do You Need a Permit to Remodel in Clark County, WA? (2026 Guide)",
    ...
    "readTime": 6,
    "seoTitle": "Clark County, WA Remodel Permits (2026): What Needs One, What Doesn't | Handy Pioneers",
    "seoDesc": "The short answer: structural, electrical, plumbing, and most additions need a permit; paint, flooring, and cabinet swaps usually don't. The 2026 plain-English guide for Clark County and Vancouver, WA, and what skipping a permit costs you at resale.",
    "references": [
      {
  ...
  // ─── Post 4 - March 20 (Fri) ─────────────────────────────────────────────
  {
    ...
    body: [
      ...
      { type: "p", text: "For what it is worth, we do not describe ourselves as a handyman company. Handy Pioneers is a proactive home service and remodel company: we take the small repair list seriously, we run full remodels, and we work homes on a documented plan through the 360° Method so problems get caught early instead of discovered late. But the questions below apply to whoever you hire, us included." },
  ...
  // ─── Post 13 - April 21 (Tue) ─────────────────────────────────────────────
  {
    ...
    body: [
      ...
      { type: "p", text: "That is the whole reason Handy Pioneers exists as a proactive home service and remodel company rather than a call-when-it-breaks repair shop. We assess a home against the 360° Method, put the condition of every system in writing, and work a prioritized plan. For an agent, that written record is the useful part: you can hand a seller a clear scope before listing, or hand a buyer a plan for the house they just bought, instead of a stack of guesses. Work is priced by the project, so the number you take to your client is the number." },
...

  {
    ...
    image: "https://handypioneers.com/images/blog/what-bbb-accreditation-means-contractor.webp",
    imageAlt: "A written home care plan and a pen on a kitchen table, morning light",
    readTime: 4,
  ...
  {
    slug: "home-equity-101-your-biggest-lever",
    title: "Home Equity 101: What It Is and Why It Is Your Biggest Lever",
    excerpt:
    ...
    audience: ["Homeowners"],
    tags: ["home equity", "what is home equity", "home equity Clark County", "home value", "360 Method"],
    image: "https://handypioneers.com/images/blog/home-equity-101-your-biggest-lever.webp",
    imageAlt: "A handsome, well-kept Pacific Northwest home presented as a valuable long-term asset",
    readTime: 6,
    seoTitle: "Home Equity 101: What It Is and Why It Matters | Handy Pioneers",
    seoDesc:
      "What is home equity, how does it grow, and how do homeowners use it to fund projects? A plain-English guide for Clark County, WA. Educational, not financial advice.",
    references: [
      ...
      { label: "Consumer Financial Protection Bureau: What is a home equity line of credit (HELOC)?", url: "https://www.consumerfinance.gov/ask-cfpb/what-is-a-home-equity-line-of-credit-heloc-en-107/" },
    ],
    body: [
      { type: "p", text: "For most families, the home is the single largest thing they own. And inside that home sits a pool of value most people barely think about until they need it: their equity. Understanding it is one of the most useful things you can do as a homeowner, because it changes how you think about repairs, remodels, and the long game of owning a house." },
      { type: "p", text: "Quick note before we start: we are a home care and remodeling contractor, not a lender or a financial advisor. This is general education to help you ask better questions, not advice about your specific situation. For that, talk to your bank and a financial professional." },
      { type: "h2", text: "What home equity actually is" },
      { type: "p", text: "Home equity is the part of your home you truly own. It is the current market value of the home minus whatever you still owe on the mortgage. If your home is worth about $500,000 and you owe about $300,000, you have roughly $200,000 in equity. That is real value, even though it is not sitting in your checking account." },
      { type: "h2", text: "How equity grows" },
      { type: "p", text: "Your equity tends to grow two ways at once:" },
      { type: "ul", items: [
      ...
      { type: "p", text: "Maintenance and smart improvements feed the second one. A home that is kept up and documented holds its value better than one that is patched only when something fails. That is the whole idea behind proactive home care." },
      { type: "h2", text: "Why equity is a lever" },
      { type: "p", text: "Equity matters not just as a number on paper but because you can borrow against a portion of it when you want to invest back into the home. Because that kind of borrowing is secured by the house, the rates are usually lower than unsecured credit like a personal loan or a credit card. Lenders generally let you borrow against part of your value, not all of it, keeping a cushion. The two common tools are a home equity loan (a lump sum at a fixed rate) and a HELOC (a flexible line of credit). We break those down in their own guides." },
      { type: "h2", text: "Where this fits in the 360 Method" },
      { type: "p", text: "The final stage of our 360 Method is Scale: reading your home's value and equity over time and making decisions like the asset it is. Most contractors think project to project. We think in years. Knowing what your equity is, how it is growing, and how it could fund the right work is part of being a real partner in your home, not just the person you call when something breaks." },
      { type: "h2", text: "The honest caution" },
      { type: "p", text: "Borrowing against equity turns value you own into debt secured by your home. Used well, on work that protects or grows the home's value, it is one of the smartest tools a homeowner has. Used carelessly, it puts the home at risk. The point is not to borrow more; it is to understand the lever so you can decide clearly." },
      { type: "cta", text: "See all the ways homeowners fund a project, and an honest guide to deciding between them.", ctaLabel: "Explore your financing options", ctaAction: "link", ctaHref: "/financing" },
    ],
  },

  {
    slug: "heloc-vs-home-equity-loan-plain-english",
    title: "HELOC vs Home Equity Loan, in Plain English",
    excerpt:
    ...
    category: "Home Equity & Financing",
    audience: ["Homeowners"],
    tags: ["HELOC vs home equity loan", "home equity loan", "HELOC", "home financing", "Clark County"],
    image: "https://handypioneers.com/images/blog/heloc-vs-home-equity-loan-plain-english.webp",
    imageAlt: "Two house keys side by side next to a small model house, suggesting two options",
    readTime: 6,
    seoTitle: "HELOC vs Home Equity Loan: Plain-English Comparison | Handy Pioneers",
    seoDesc:
      "HELOC or home equity loan? The real difference, when each fits, and the tradeoffs, in plain English for Clark County, WA homeowners. Educational, not financial advice.",
    references: [
      { label: "Consumer Financial Protection Bureau: Difference between a home equity loan and a HELOC", url: "https://www.consumerfinance.gov/ask-cfpb/what-is-the-difference-between-a-home-equity-loan-and-a-home-equity-line-of-credit-heloc-en-247/" },
      { label: "Consumer Financial Protection Bureau: What is a home equity loan?", url: "https://www.consumerfinance.gov/ask-cfpb/what-is-a-home-equity-loan-en-106/" },
      { label: "Consumer Financial Protection Bureau: What is a home equity line of credit (HELOC)?", url: "https://www.consumerfinance.gov/ask-cfpb/what-is-a-home-equity-line-of-credit-heloc-en-107/" },
    ],
    body: [
      { type: "p", text: "If you have looked into paying for a project with your home's equity, you have run into two terms: a home equity loan and a HELOC. They sound similar and both borrow against the same thing, your equity. But they behave differently, and the right one depends on your project and how you like to manage money." },
      { type: "p", text: "We are a contractor, not a lender or a financial advisor, so take this as plain education, not advice. Your lender will give you the real terms for your situation." },
      { type: "h2", text: "Home equity loan: a lump sum at a fixed payment" },
      { type: "p", text: "A home equity loan gives you the full amount up front, in one lump sum, and you pay it back in equal monthly payments. The interest rate is usually fixed, so your payment does not change for the life of the loan. It is predictable: you know the number on day one and it stays the number." },
      { type: "p", text: "That predictability makes it a natural fit for a defined project with a known cost, like a kitchen or a bath where the scope is set and you want one steady payment." },
      { type: "h2", text: "HELOC: a flexible line you draw from" },
      { type: "p", text: "A HELOC is a line of credit secured by your home. Instead of a lump sum, you get access to a limit you can draw from as you need, during what is called the draw period, which often runs about 10 years. You pay interest only on what you have actually drawn, and as you repay, your available credit refills, similar to a credit card." },
      { type: "p", text: "Two things to know. The rate is usually variable, so it can move up or down over time. And after the draw period ends, you enter the repayment period, when you can no longer draw and the monthly payment is often significantly higher. That flexibility is powerful for phased or open-ended work, but the payment is less predictable than a fixed loan." },
      ...
      { type: "h2", text: "Both are secured by your home" },
      { type: "p", text: "Whichever you choose, the loan is secured by your house. That is what keeps the rates lower than unsecured credit, and it is also the real risk: if you fall behind, the home is on the line. Borrow against a project and terms that are genuinely worth it." },
      { type: "h2", text: "How we think about it" },
      { type: "p", text: "The financing is your call and your lender's. Our job is to make sure the project itself is scoped right and priced honestly, so whatever you borrow goes to work that protects or grows your home's value. That is the partnership behind the 360 Method: the right work, in the right order, funded in a way that fits your life." },
      { type: "cta", text: "See how a HELOC, a home equity loan, and cash compare side by side, with an honest decision guide.", ctaLabel: "Explore your financing options", ctaAction: "link", ctaHref: "/financing" },
    ],
  },

  {
    slug: "cash-vs-financing-home-project",
    title: "Cash or Financing: How to Decide How to Pay for a Home Project",
    excerpt:
    ...
    category: "Home Equity & Financing",
    audience: ["Homeowners"],
    tags: ["cash vs financing", "pay for home remodel", "home equity vs cash", "remodel budget", "Clark County"],
    image: "https://handypioneers.com/images/blog/cash-vs-financing-home-project.webp",
    imageAlt: "A model house, a stack of coins, and a calculator on a desk by a window",
    readTime: 6,
    seoTitle: "Cash or Financing for a Home Project: How to Decide | Handy Pioneers",
    seoDesc:
      "Should you pay cash or finance your home project? An honest way to weigh savings, project size, risk, and taxes for Clark County, WA homeowners. Not financial advice.",
    references: [
      { label: "IRS Publication 936: Home Mortgage Interest Deduction", url: "https://www.irs.gov/publications/p936" },
      { label: "Consumer Financial Protection Bureau: What is a home equity line of credit (HELOC)?", url: "https://www.consumerfinance.gov/ask-cfpb/what-is-a-home-equity-line-of-credit-heloc-en-107/" },
    ],
    body: [
      { type: "p", text: "When a project gets big enough, the question is not only what to do, but how to pay for it. Cash or financing? People often assume cash is always the smarter choice. Sometimes it is. Sometimes it is not. Here is how to think it through honestly." },
      { type: "p", text: "As always, we are a contractor, not a financial advisor. This is a framework for your own thinking, not advice for your specific numbers." },
      { type: "h2", text: "The case for paying cash" },
      { type: "p", text: "Cash is clean. No interest, no application, no debt against the house. If you have savings well beyond a solid emergency fund, and the project is one you would happily fund out of pocket, paying cash is often the simplest good answer." },
      { type: "h2", text: "The case for financing" },
      { type: "p", text: "Financing is not a sign you cannot afford something. It is a tool. Borrowing against your equity lets you keep your cash reserves intact for real emergencies, do the whole project now instead of waiting years to save, and spread the cost over time. Because home-secured borrowing usually carries lower rates than credit cards or personal loans, the cost of that flexibility can be reasonable." },
      ...
      { type: "h2", text: "One tax angle worth knowing" },
      { type: "p", text: "The IRS allows interest on a home equity loan or HELOC to be deducted only when the money is used to buy, build, or substantially improve the home that secures the loan, and other limits apply. Renovating that same home is often exactly that case, which can shift the math a little toward financing. Rules vary by situation, so confirm it with a tax professional before counting on it." },
      { type: "h2", text: "How we help" },
      { type: "p", text: "We will not tell you how to pay. We will give you honest pricing up front and a clearly scoped project, so whichever path you choose, you are deciding with real numbers. That is the 360 Method partnership: clarity first, pressure never." },
      { type: "cta", text: "Walk through the full decision guide and the four common ways to fund a project.", ctaLabel: "Explore your financing options", ctaAction: "link", ctaHref: "/financing" },
    ],
  },

  {
    slug: "what-a-heloc-actually-is",
    title: "What a HELOC Actually Is (Draw Periods, Variable Rates, and How a Line of Credit Works)",
    excerpt:
    ...
    category: "Home Equity & Financing",
    audience: ["Homeowners"],
    tags: ["what is a HELOC", "HELOC draw period", "home equity line of credit", "variable rate", "Clark County"],
    image: "https://handypioneers.com/images/blog/what-a-heloc-actually-is.webp",
    imageAlt: "A glass jar of coins beside a small wooden model house on a sunlit windowsill",
    readTime: 6,
    seoTitle: "What a HELOC Actually Is: How a Home Equity Line of Credit Works | Handy Pioneers",
    seoDesc:
      "How a HELOC really works: draw periods, variable rates, repayment, and when it fits. A plain guide for Clark County, WA homeowners. Educational, not financial advice.",
    references: [
      { label: "Consumer Financial Protection Bureau: What is a home equity line of credit (HELOC)?", url: "https://www.consumerfinance.gov/ask-cfpb/what-is-a-home-equity-line-of-credit-heloc-en-107/" },
      { label: "Consumer Financial Protection Bureau: What you should know about home equity lines of credit", url: "https://files.consumerfinance.gov/f/documents/cfpb_heloc-brochure.pdf" },
    ],
    body: [
      { type: "p", text: "Of all the ways to fund home projects, the HELOC is the one people most often half-understand. It is flexible and useful, but it works differently from a normal loan, and the differences matter. Here is the plain version." },
      { type: "p", text: "We are a contractor, not a lender. This explains how the tool works in general; your lender sets your actual terms." },
      { type: "h2", text: "It is a line of credit, not a lump sum" },
      { type: "p", text: "HELOC stands for home equity line of credit. It is an open-end line, secured by your home, that you can borrow from repeatedly up to a set limit, rather than a single lump sum. In that way it behaves more like a credit card than a traditional loan: you draw what you need, and as you pay it back, your available credit refills." },
      { type: "h2", text: "The draw period" },
      { type: "p", text: "For the first stretch, called the draw period, you can borrow from the line whenever you want, up to your limit. This often lasts around 10 years. During this time you typically pay interest only on the amount you have actually drawn, not the whole limit. That is what makes a HELOC handy for phased projects: you pull money as the work happens instead of paying interest on a big sum sitting idle." },
      { type: "h2", text: "The repayment period" },
      { type: "p", text: "When the draw period ends, the HELOC shifts into the repayment period. You can no longer draw from it, and you begin paying back the balance. Monthly payments are often significantly higher in this phase, because you are now paying down principal as well as interest. This is the part people are most often surprised by, so it is worth planning for from the start." },
      { type: "h2", text: "The variable rate" },
      { type: "p", text: "Most HELOCs carry a variable interest rate, which means it can rise or fall over time with the market. A lower payment today might be a higher payment in a couple of years. That flexibility cuts both ways, and it is the main tradeoff against the steady, fixed payment of a home equity loan." },
      { type: "h2", text: "When a HELOC fits, and the risk" },
      { type: "p", text: "A HELOC shines for projects where the cost is not fully nailed down, or where you want to fund work in stages over time. The risk is the same as any home-secured borrowing: it is tied to your house, so falling behind puts the home at stake. Treat the limit as a tool for value-adding work, not a slush fund." },
      { type: "h2", text: "Our role in it" },
      { type: "p", text: "We do not arrange financing. What we do is scope the work clearly and price it honestly, so if you do use a HELOC, every dollar you draw goes to a project worth doing. That is the long-term partnership the 360 Method is built on." },
      { type: "cta", text: "Compare a HELOC against a home equity loan and paying cash, with an honest decision guide.", ctaLabel: "Explore your financing options", ctaAction: "link", ctaHref: "/financing" },
    ],
  },

  {
    slug: "why-most-projects-not-paid-cash",
    title: "Why Most Big Home Projects Are Not Paid in Cash (and Why That Is Normal)",
    excerpt:
    ...
    category: "Home Equity & Financing",
    audience: ["Homeowners"],
    tags: ["financing a remodel", "pay for home project", "home equity", "remodel financing", "Clark County"],
    image: "https://handypioneers.com/images/blog/why-most-projects-not-paid-cash.webp",
    imageAlt: "A premium finished open-concept kitchen and living remodel in a PNW home",
    readTime: 5,
    seoTitle: "Why Most Big Home Projects Are Not Paid in Cash | Handy Pioneers",
    seoDesc:
      "Funding a large home project is normal, not a red flag. Why most homeowners finance big work, and how to do it sensibly. Clark County, WA. Not financial advice.",
    references: [
      { label: "Consumer Financial Protection Bureau: What is a home equity loan?", url: "https://www.consumerfinance.gov/ask-cfpb/what-is-a-home-equity-loan-en-106/" },
    ],
    body: [
      { type: "p", text: "There is a quiet assumption that a responsible homeowner pays cash for everything, and that financing a project means you could not really afford it. We want to push back on that gently, because it stops good people from doing smart, value-protecting work on their homes." },
      { type: "p", text: "Quick reminder: we are a contractor, not a financial advisor. This is perspective, not advice." },
      { type: "h2", text: "Look at how big purchases actually work" },
      { type: "p", text: "Most cars on the road were financed, not bought outright, and nobody thinks twice about it. The same is true of large home projects. Spreading the cost of a major, long-lasting improvement over time, rather than draining your savings in one shot, is a normal and often sensible way to handle a big asset." },
      { type: "h2", text: "Why cash is not automatically the win" },
      { type: "p", text: "Paying cash feels virtuous, but it has a real cost too: it takes your cushion. If a single project empties the reserve you would want when the furnace dies or the roof leaks, you have traded one risk for another. Keeping cash liquid has value. Sometimes that value is worth more than the interest you would save." },
      { type: "h2", text: "When financing is the smart move" },
      { type: "ul", items: [
      ...
      { type: "h2", text: "The goal is the right project, funded sensibly" },
      { type: "p", text: "None of this is a push to borrow. It is permission to stop feeling behind. The real goal is the right project, scoped honestly and paid for in a way that fits your life, whether that is cash, equity, or a mix. That is exactly the conversation the 360 Method is built around: your home as an asset, managed over the long run." },
      { type: "cta", text: "See the four common ways to fund a project, and an honest guide to choosing.", ctaLabel: "Explore your financing options", ctaAction: "link", ctaHref: "/financing" },
    ],
  },

  {
    slug: "step-9-reading-home-equity-over-time",
    title: "Step 9 of the 360 Method: Reading Your Home's Equity Over Time",
    excerpt:
    ...
    category: "Home Equity & Financing",
    audience: ["Homeowners"],
    tags: ["360 Method", "home equity over time", "home as an asset", "Scale step", "Clark County", "partnership"],
    image: "https://handypioneers.com/images/blog/step-9-reading-home-equity-over-time.webp",
    imageAlt: "A well-maintained craftsman home at dusk with warm lights, appreciating over time",
    readTime: 6,
    seoTitle: "Step 9 of the 360 Method: Reading Your Home's Equity Over Time | Handy Pioneers",
    seoDesc:
      "The 360 Method's final step, Scale, treats your home as an asset: reading value and equity over time, and partnering for the long run. Clark County, WA.",
    references: [
      { label: "Consumer Financial Protection Bureau: What is a home equity loan?", url: "https://www.consumerfinance.gov/ask-cfpb/what-is-a-home-equity-loan-en-106/" },
      { label: "IRS Publication 936: Home Mortgage Interest Deduction", url: "https://www.irs.gov/publications/p936" },
    ],
    body: [
      { type: "p", text: "Most contractors meet you at a single moment: something is broken, they fix it, they leave. The 360 Method is built differently, as a relationship with your home over years. And the final step of that method, Step 9, is the one that ties money to care. We call it Scale." },
      { type: "h2", text: "The three phases, quickly" },
      { type: "p", text: "The 360 Method moves through three phases. Aware: document the condition of every major system so you know what you actually have. Act: work a prioritized plan so small issues never become big losses. Advance: keep the home maintained and improving so it holds and grows its value. Scale is the last step of Advance." },
      { type: "h2", text: "What Scale means" },
      { type: "p", text: "Scale is reading your home's value and equity over time and making decisions like the asset it is. Not reacting when something fails, but watching the long arc: what the home is worth, what you owe, how the equity is building, and what work would protect or grow it. It is the difference between owning a house and managing an asset." },
      { type: "h2", text: "Why financing knowledge belongs here" },
      { type: "p", text: "Once you see the home as an asset, the question of how to fund work on it becomes part of the plan, not an afterthought. Knowing the difference between a home equity loan and a HELOC, understanding when financing beats cash, and knowing that interest on money used to substantially improve the home may even be tax-deductible (confirm with a tax professional): these are not separate from home care. They are part of stewarding the asset well." },
      { type: "p", text: "We are not lenders or financial advisors, and we will never pretend to be. But a good partner makes sure you are informed before a big decision, the same way a good guide points out the terrain before you walk it." },
      { type: "h2", text: "Sell, refinance, or stay" },
      { type: "p", text: "Reading equity over time also sharpens the bigger choices. If you may sell, the plan favors work that holds and improves resale value. If you may refinance or borrow, documented condition and rising equity strengthen your position. If you are staying for the long run, the plan favors durability and comfort. Same home, different smart moves, and Scale is how you tell which is which." },
      { type: "h2", text: "The point of all of it" },
      { type: "p", text: "Step 9 is where home care stops being a series of repairs and becomes a strategy. Your home is likely your biggest asset. It deserves to be read, planned, and funded with that in mind, by someone who is still around in five years to see how it played out. That is the partnership we are trying to be." },
      { type: "cta", text: "Understand your options for funding the work that grows your home's value.", ctaLabel: "Explore your financing options", ctaAction: "link", ctaHref: "/financing" },
    ],
  },

  {
    slug: "deck-repair-vancouver-wa-five-failures",
    title: "Deck Repair in Vancouver, WA: The Five Failures We Find Most",
    excerpt: "Most deck problems in Clark County start underneath, where you cannot see them. Here are the five failures we find most on Vancouver decks, what each one means, and which ones are repairable versus a sign the deck is done.",
    date: "July 28, 2026",
    isoDate: "2026-07-28",
    ...
    category: "Decks & Exterior",
    audience: ["Homeowners"],
    tags: ["deck repair Vancouver WA", "deck inspection", "ledger board", "deck rot", "Clark County decks"],
    image: "https://handypioneers.com/images/blog/deck-water-damage-signs-camas.webp",
    imageAlt: "A Vancouver WA deck with framing exposed during a repair",
    readTime: 5,
    seoTitle: "Deck Repair in Vancouver, WA: The 5 Failures We Find Most | Handy Pioneers",
    seoDesc: "What actually fails on Clark County decks: the ledger connection, rotted joists, post bases, railings, and surface boards. Which are repairable, which mean rebuild, and how to check yours.",
    body: [
      { type: "p", text: "If your Vancouver deck has a soft board, a wobbly railing, or a section that bounces underfoot, here is the short answer: the visible symptom is usually not the real problem. In our climate a deck spends most of the year wet, and the failures start at the connections and the framing underneath. Five failures account for nearly every deck repair we do in Clark County: the ledger connection, rotted joists, post bases, failed railings, and worn surface boards. The first three are structural and worth checking this month, not next year." },
      { type: "h2", text: "1. The ledger connection (the one that matters most)" },
      { type: "p", text: "The ledger is the board that bolts the deck to your house. When flashing was skipped or fails, water runs behind it and quietly rots both the ledger and the rim of the house itself. A failed ledger is the leading cause of deck collapses, and it is the first thing we inspect on every deck. Signs: the deck pulling away from the house, rust streaks under the connection, or any movement when people walk out on it." },
      { type: "h2", text: "2. Rotted joists, starting at the fasteners" },
      { type: "p", text: "Joists rot from the top down, right where the deck boards screw into them, because every fastener hole holds water. The deck surface can look fine while the framing under it crumbles. The screwdriver test works here: if the tip sinks into a joist with light pressure, that joist is done. A few bad joists are a repair. Rot across most of the frame is a rebuild conversation." },
      { type: "h2", text: "3. Post bases and footings" },
      { type: "p", text: "Posts fail at the bottom, where they meet concrete and stay damp. Older decks often have posts buried in soil or set directly on pads with no standoff, which in this climate is a countdown. Heaved or sunken footings show up as a deck that slopes or a stair that no longer lands right. Post and footing work is very repairable when caught early." },
      { type: "h2", text: "4. Railings and stairs" },
      { type: "p", text: "Wobbly railings and spongy stair stringers are the failures that actually hurt people. They are also usually the cheapest of the five to fix properly. If a railing moves when you lean on it, treat it as urgent, especially with kids or older guests around." },
      { type: "h2", text: "5. Surface boards" },
      { type: "p", text: "Cupped, cracked, or gray-and-soft boards are the failure everyone sees, and the least serious of the five. If the frame below is sound, new decking transforms the deck for a fraction of a rebuild. If you are choosing materials, we compared composite and wood for this climate in a separate post." },
      { type: "h2", text: "Repair or rebuild? The frame decides" },
      { type: "p", text: "The rule we use: if the ledger, most joists, and the posts are sound, repair. If the structure itself is going, repairs just buy expensive time, and a rebuild sized and flashed for the Pacific Northwest is the honest recommendation. We put both paths in writing after an inspection, with a price for each, so you decide with real information." },
      { type: "p", text: "This is also exactly the kind of problem that never gets to the scary stage on a maintained home. Proactive Path members get the deck structure and ledger checked on schedule, so a loose connection is a note in a report, not a Saturday emergency." },
      { type: "cta", text: "Want eyes on your deck before the next wet season? We inspect the structure first and give you a written answer: repair, rebuild, or leave it alone.", ctaLabel: "See Deck Repair & Rebuild", ctaAction: "link", ctaHref: "/services/deck-repair" },
    ],
  },

  {
    slug: "house-washing-vancouver-wa-soft-wash-vs-pressure-wash",
    title: "House Washing in Vancouver, WA: Soft Wash or Pressure Wash?",
    excerpt: "The green film on Clark County siding is algae, and blasting it with high pressure is how siding gets ruined. Here is when soft washing is right, when pressure washing is right, and what a proper house wash looks like.",
    date: "July 31, 2026",
    isoDate: "2026-07-31",
    ...
    category: "Painting & Exterior",
    audience: ["Homeowners"],
    tags: ["house washing Vancouver WA", "vinyl siding cleaning", "soft wash", "pressure washing", "algae on siding"],
    image: "https://handypioneers.com/images/blog/pressure-washing-3-driveways-in-one-week-vancouver.webp",
    imageAlt: "Exterior cleaning in progress on a Vancouver WA home",
    readTime: 5,
    seoTitle: "House Washing in Vancouver WA: Soft Wash vs Pressure Wash | Handy Pioneers",
    seoDesc: "Siding, roofs, and painted wood need low-pressure soft washing; concrete takes real pressure. How to clean the PNW green film off vinyl siding without forcing water into your walls.",
    body: [
      { type: "p", text: "Short answer: siding gets soft washed, concrete gets pressure washed, and mixing those up is how exteriors get damaged. The green film that grows on north-facing siding all over Vancouver and Clark County is algae, and it comes off with a low-pressure wash and the right cleaning solution. High pressure on vinyl or wood siding forces water behind the panels, strips paint, and voids some siding warranties, which is why the cheapest quote on a house wash is often the most expensive one you can accept." },
      { type: "h2", text: "Why every house here turns green" },
      { type: "p", text: "Algae and mildew need shade and moisture, and a Pacific Northwest winter delivers eight months of both. North and east walls, under eaves, and anywhere trees block sun will grow the film first. It is not just cosmetic: the growth holds moisture against the surface, which shortens paint life and feeds the conditions rot needs." },
      { type: "h2", text: "Soft washing: siding, roofs, painted wood" },
      { type: "p", text: "A soft wash uses garden-hose-level pressure with a cleaning solution that kills the growth, then rinses it away. Done right, the algae dies at the root, so the siding stays clean far longer than a pressure-only blast that just shaves the surface off the growth and leaves it to regrow. Vinyl, fiber cement, painted wood, stucco, and roofs should all be washed this way. If a quote for your siding only mentions a pressure washer, ask what pressure they intend to use on the walls. It is a fair question, and the answer tells you a lot." },
      { type: "h2", text: "Pressure washing: concrete and stone" },
      { type: "p", text: "Driveways, walkways, patios, and pavers are where real pressure belongs. The transformation on a Clark County driveway that has not been cleaned in a few years is dramatic, which is why before-and-after photos of concrete are the ones you always see. Decks sit in between: wood decking takes a careful low-to-moderate pressure wash, never the tip you use on concrete, or the grain furs up and splinters." },
      { type: "h2", text: "When to do it, and how often" },
      { type: "p", text: "Late spring through early fall is the window, once the surfaces can dry. For most homes here, a full exterior wash every one to two years keeps growth from getting established, and it is the single best preparation for exterior paint to last. We fold exterior washing into seasonal care for members for exactly that reason: it is cheap prevention against expensive problems." },
      { type: "cta", text: "One team can wash the house, clean the concrete, and flag anything underneath that needs attention while we are up close to it.", ctaLabel: "See Pressure Washing & House Washing", ctaAction: "link", ctaHref: "/services/pressure-washing" },
    ],
  },

  {
    slug: "is-it-dry-rot-how-to-tell-clark-county",
    title: "Is It Dry Rot? How to Tell, and What to Do Before the Rain Comes Back",
    excerpt: "A screwdriver, two minutes, and the six places rot starts on Clark County homes. How to tell cosmetic weathering from real rot, and why late summer is the right time to fix it.",
    date: "August 4, 2026",
    isoDate: "2026-08-04",
    ...
    category: "Seasonal Home Care",
    audience: ["Homeowners"],
    tags: ["dry rot repair Vancouver WA", "wood rot", "rot inspection", "siding rot", "window sill rot"],
    image: "https://handypioneers.com/images/blog/porch-step-repair-battle-ground-safety-wake-up-call.webp",
    imageAlt: "Rotted exterior wood on a Clark County porch being repaired",
    readTime: 5,
    seoTitle: "Is It Dry Rot? How Clark County Homeowners Can Tell | Handy Pioneers",
    seoDesc: "The screwdriver test, the six places rot starts on Vancouver WA homes, dry rot vs wet rot in plain English, and why August is the month to repair it.",
    body: [
      { type: "p", text: "Here is the two-minute test: press a screwdriver into the suspect wood with light hand pressure. Sound wood resists and the tip skates. Rotted wood gives, crumbles, or lets the tip sink in. Add the other signs (paint that bubbles or peels in the same spot every year, dark staining at joints, wood that looks dry and blocky like burnt firewood, a musty smell near a window or door) and you have your answer without opening a wall. In Clark County, if you found one soft spot, it is worth checking the usual suspects below, because rot rarely travels alone." },
      { type: "h2", text: "Dry rot, wet rot: the name that confuses everyone" },
      { type: "p", text: "Dry rot is a misleading name. All rot is a fungus, and every rot fungus needs moisture to get started. The type called dry rot is simply the one that can carry moisture along its growth into wood that would otherwise stay dry, which makes it the more aggressive spreader. For a homeowner the distinction changes nothing about the fix: find the water, stop it, replace what failed. Anyone who quotes you a rot repair without explaining where the water is coming from is selling you the same repair again in three years." },
      { type: "h2", text: "The six places rot starts here" },
      { type: "ul", items: [
        "Window sills and the trim below them, where water sits after every storm",
        "Door frames at the bottom corners, especially doors without an overhang",
        "Fascia boards behind clogged or leaking gutters",
        "Siding butt joints and the bottom edge of siding runs, where end grain drinks water",
        "Deck posts at their base and deck framing at the fastener lines",
        "Anywhere two roof lines meet a wall and flashing was done poorly",
      ] },
      { type: "h2", text: "Why late summer is the moment" },
      { type: "p", text: "Rot spreads while wood is damp, which here means October through May. August and September are when the wood is at its driest, repairs cure properly, and new work can be primed and sealed before the wet season starts the clock again. A rot repair completed in September faces its first winter protected. The same repair booked in November happens on a wet wall, costs more to do right, and the damage kept growing while you waited on the schedule." },
      { type: "h2", text: "What a proper repair includes" },
      { type: "p", text: "Trace the moisture path and fix the cause. Remove the failed wood past the visible damage, because rot runs ahead of what you can see. Replace with sound material, then prime and seal every cut edge before the rain returns. That sequence is the difference between a repair and a redecoration." },
      { type: "cta", text: "Posts are the one on that list with a specific, fixable cause. We opened up a Camas porch and photographed it.", ctaLabel: "Why porch posts rot at the bottom", ctaAction: "link", ctaHref: "/blog/why-porch-posts-rot-at-the-bottom" },
      { type: "p", text: "And if you would rather never run the screwdriver test yourself: catching rot while it is a trim board instead of a wall is precisely what the Proactive Path seasonal checks exist to do. Our members hear about soft spots from us, in a written report, while the fix is still small." },
      { type: "cta", text: "Found a soft spot, or want us to check the six places on your home before winter? We trace the cause, fix what failed, and seal it against the season.", ctaLabel: "See Rot Repair", ctaAction: "link", ctaHref: "/services/rot-repair" },
    ],
  },

  {
    slug: "gutters-battle-ground-clean-repair-or-replace",
    title: "Gutters in Battle Ground, WA: Clean, Repair, or Replace?",
    excerpt: "Under firs and cedars, gutters fill all winter, not just in fall. How Battle Ground homeowners can tell whether their gutters need a cleaning, a repair, or a replacement, and the order to decide it in.",
    date: "August 7, 2026",
    isoDate: "2026-08-07",
    ...
    body: [
      ...
      { type: "p", text: "When we replace, we check and repair the fascia first, then hang the new run with the right pitch for the roof area it drains. Doing it in the other order is how a new gutter fails in two years." },
      { type: "p", text: "We serve all of Battle Ground and the surrounding areas, and gutter checks are a standing item on our members' seasonal visits: cleared, tested, and documented before the wet season, every year, without you thinking about it." },
      { type: "cta", text: "Want your gutters cleared, fixed, or honestly assessed before fall? We will tell you which of the three you actually need, in writing.", ctaLabel: "See Gutter Services", ctaAction: "link", ctaHref: "/services/gutter-services" },
    ],
  },

  {
    slug: "the-fix-it-list-small-repairs-vancouver-handyman",
    title: "The Fix-It List: What a Vancouver Handyman Handles in One Visit",
    excerpt: "The door that will not latch, the cabinet hinge, the squeaky stair, the wobbly railing. None of them justify a contractor call on their own, which is why they never get fixed. Bundled into one visit, they do.",
    date: "August 11, 2026",
    isoDate: "2026-08-11",
    ...
    audience: ["Homeowners"],
    tags: ["handyman Vancouver WA", "small home repairs", "door repair", "cabinet repair", "drywall repair", "fix-it list"],
    image: "https://handypioneers.com/images/blog/5-home-repairs-clark-county-homeowners-keep-putting-off.webp",
    imageAlt: "A list of small home repairs being worked through in a Vancouver WA home",
    readTime: 5,
    seoTitle: "The Fix-It List: Small Repairs a Vancouver WA Handyman Handles in One Visit | Handy Pioneers",
    seoDesc: "Doors, cabinets, drywall, caulk, railings, squeaks, weatherstripping: the small repairs that never get fixed alone, and how bundling them into one handyman visit finally clears the list.",
    body: [
      { type: "p", text: "Yes, a handyman handles these, and no, your list is not too small. The door that will not latch, the cabinet door that sags, the drywall dings from the last move, the squeaky stair, the wobbly closet rod, the caulk going dark around the tub: every home in Vancouver has a list like this. Each item is twenty minutes to two hours of work, which is exactly why they never get done. No one wants to book a contractor for one hinge, and most contractors will not call back for it. The answer is not to wait until something is big enough. It is to bundle the list into one visit. We are a proactive home service and remodel company rather than a handyman outfit, which mostly means we would rather your list never grow this long in the first place, and we price the visit by the work, not by the hour." },
      { type: "h2", text: "What belongs on a fix-it list" },
      { type: "ul", items: [
        "Doors: latches, sticking, sagging hinges, handles and deadbolts, weatherstripping, a full door replacement where the slab itself is done",
        "Cabinets: hinges, drawer slides, pulls, a door that never closed right since the day it was installed",
        "Walls and trim: drywall patches, nail pops, cracked caulk lines, baseboard and casing repairs",
        "Floors and stairs: squeaks, loose transition strips, a stair nose that moves underfoot",
        "Safety items: wobbly railings, loose grab bars, attic ladders, that step everyone warns guests about",
        "Water-adjacent small jobs: recaulking tubs and showers, a running toilet, a faucet swap, sealing gaps where water sneaks in",
        "Exterior quick hits: a fence board, a gate latch, a loose downspout, trim touch-ups before the rain",
      ] },
      { type: "h2", text: "What does not belong on it" },
      { type: "p", text: "Honesty about the lane matters. We do not repair appliances, and full roof replacements and new electrical panels belong with those dedicated trades. If an item on your list is one of those, we will say so on the spot and tell you what kind of company to call, because a fix-it visit should end with everything either fixed or clearly routed, not with a maybe." },
      { type: "h2", text: "How to make the list work" },
      { type: "p", text: "Walk the house once with your phone and photograph everything that is broken, loose, sticking, squeaking, or stained. Do not filter by whether it seems worth calling about; that filter is why the list is three years old. Send us the photos with a line each. We come once, work the list top to bottom, and anything that turns out to be bigger than it looked gets a written scope instead of a surprise." },
      { type: "h2", text: "Or never keep the list at all" },
      { type: "p", text: "This is the quiet best part of the Proactive Path membership: members do not accumulate a fix-it list. Small repairs get bundled into the seasonal visits that are already happening, so the door gets fixed the season it starts sticking. The list stays at zero, and the house feels like someone is taking care of it, because someone is." },
      { type: "cta", text: "Have a list like this? Send it over, photos and all. One visit, worked top to bottom.", ctaLabel: "Book a visit", ctaAction: "booking" },
    ],
  },
