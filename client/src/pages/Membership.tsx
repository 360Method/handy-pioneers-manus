      ...
      <section className="py-16 px-4" style={{ background: "oklch(22% 0.07 155)" }}>
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            full-restoration projects we rebuild to sound structure carry a two-year guarantee. If
