...
const photos: Photo[] = [
  ...
  {
    id: 12,
    src: "/images/hero-gallery/nRlKKIJALACEEquv.jpg",
  ...
  {
    id: 14,
    src: "/images/hero-gallery/qMQRAbINWFvrUPEB.jpg",
    caption: "Bathroom remodel featuring new flooring, trim, and toilet replacement",
    tag: "Remodel",
  },
  {
    id: 15,
    src: "/images/hero-gallery/jPOgJPckBdaPcCPr.jpg",
